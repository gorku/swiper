...
import { $, addClass, removeClass, hasClass, toggleClass, attr, removeAttr, data, transform, transition as transition$1, on, off, trigger, transitionEnd as transitionEnd$1, outerWidth, outerHeight, offset, css, each, html, text, is as is$1, index, eq, append, prepend, next, nextAll, prev, prevAll, parent, parents, closest, find, children, remove, add, styles } from 'dom7/dist/dom7.modular';
import { window as window$1, document as document$1 } from 'ssr-window';
...
const Support = (function Support() {
  const testDiv = document$1.createElement('div');
  return {
    touch: (window$1.Modernizr && window$1.Modernizr.touch === true) || (function checkTouch() {
      return !!((window$1.navigator.maxTouchPoints > 0) || ('ontouchstart' in window$1) || (window$1.DocumentTouch && document$1 instanceof window$1.DocumentTouch));
    }()),
...
const Device = (function Device() {
  ...
  if (device.os && device.os === 'ios') {
    ...
    const metaViewport = document$1.querySelector('meta[name="viewport"]');
...
function onTouchMove(event) {
  ...
  if (data.isTouchEvent && document$1.activeElement) {
    if (
      e.target === document$1.activeElement &&
